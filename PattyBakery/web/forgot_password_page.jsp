            ...
            <div class="forgot password form">
                <div class="form-content">
                    ...
                    <form action="login_control" method="POST">
                        ...
                        <div class="field input-field">
                            <input name='password' type="password" placeholder="New Password" class="newpassword" required>
                        </div>
                </div>
                <div class="field button-field">

                    <button type='submit' name='reset' style='width:250px'>Reset password</button>
